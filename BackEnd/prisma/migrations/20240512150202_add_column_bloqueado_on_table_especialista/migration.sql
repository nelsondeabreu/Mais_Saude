/*
  ...
  - You are about to drop the `temponotificacao` table. If the table is not empty, all the data it contains will be lost.
...
-- AlterTable
ALTER TABLE `especialistas` ADD COLUMN `bloqueado` VARCHAR(191) NULL;

-- DropTable
DROP TABLE `temponotificacao`;
