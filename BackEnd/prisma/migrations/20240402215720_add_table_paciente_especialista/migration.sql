...
-- CreateTable
CREATE TABLE `PacientesEspecialistas` (
    `id` VARCHAR(191) NOT NULL,
    `pacienteId` VARCHAR(30) NOT NULL,
    `especialistaId` VARCHAR(30) NOT NULL,

    UNIQUE INDEX `PacientesEspecialistas_pacienteId_especialistaId_key`(`pacienteId`, `especialistaId`),
    PRIMARY KEY (`id`)
