/*
  ...
  - You are about to drop the column `arquivo` on the `mensagens` table. All the data in the column will be lost.
  - You are about to drop the column `foto` on the `mensagens` table. All the data in the column will be lost.
  - You are about to drop the column `video` on the `mensagens` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `mensagens` DROP COLUMN `arquivo`,
    DROP COLUMN `foto`,
    DROP COLUMN `video`;
