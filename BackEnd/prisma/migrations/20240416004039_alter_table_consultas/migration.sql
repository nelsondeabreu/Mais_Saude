/*
  ...
  - Added the required column `status` to the `Consultas` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `consultas` ADD COLUMN `status` ENUM('Marcada', 'Realizada', 'Cancelada') NOT NULL;
