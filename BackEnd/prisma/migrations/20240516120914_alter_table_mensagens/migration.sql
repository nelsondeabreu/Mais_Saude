/*
  ...
  - You are about to drop the `pacientesespecialistas` table. If the table is not empty, all the data it contains will be lost.
...
-- AlterTable
ALTER TABLE `mensagens` ADD COLUMN `arquivo` VARCHAR(191) NULL,
    ADD COLUMN `foto` VARCHAR(191) NULL,
    ADD COLUMN `video` VARCHAR(191) NULL;

-- DropTable
DROP TABLE `pacientesespecialistas`;
