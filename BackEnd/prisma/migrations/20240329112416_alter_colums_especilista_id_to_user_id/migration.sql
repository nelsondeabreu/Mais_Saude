/*
  ...
  - You are about to drop the column `especialistaID` on the `minhasconexoes` table. All the data in the column will be lost.
  - Added the required column `userID` to the `MinhasConexoes` table without a default value. This is not possible if the table is not empty.
...
-- DropIndex
DROP INDEX `MinhasConexoes_especialistaID_fkey` ON `minhasconexoes`;
...
-- AlterTable
ALTER TABLE `minhasconexoes` DROP COLUMN `especialistaID`,
